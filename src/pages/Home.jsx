...
const Home = () => {
  ...
  return (
    <>
      <section className="relative">
        <div className="overflow-hidden pt-16 pb-48">
          <div className="container relative mx-auto px-4">
            <div className="-m-8 flex flex-col lg:flex-row items-center">
              <div className="w-full p-8 lg:w-6/12">
                <h1 className="lg:text-12xl font-heading mb-9 text-6xl font-bold leading-none md:max-w-2xl md:text-6xl">
                  Event Radar
                </h1>
                <div>
                  <p className="dark:text-gray-300ss mb-9 text-xl font-medium text-gray-900 dark:text-gray-300 md:max-w-xl">
                    Welcome to Event Radar, your go-to platform for discovering
                    exciting events happening across colleges. Explore a wide
                    range of events, from workshops and seminars to cultural
                    festivals and sports meets. Start exploring today!
                  </p>
                  <div className="mb-12 md:inline-block">
                    <button
                      onClick={() => navigate("/events")}
                      className="w-full rounded-xl border border-indigo-700 bg-indigo-600 py-4 px-14 font-semibold text-white transition duration-200 ease-in-out hover:bg-indigo-700 focus:ring focus:ring-indigo-300"
                    >
                      Explore
                    </button>
                  </div>
      ...
      <section className="overflow-hidden bg-gray-100 py-12 pb-24 dark:bg-gray-900">
        <div className="container mx-auto px-4">
          ...
          <p className="mx-auto text-center text-base font-medium leading-normal text-gray-600 dark:text-gray-400 md:max-w-lg">
            Join our community and discover the best college events together.
          </p>
        </div>
      </section>
              ...
              <div className="md:max-w-xl">
                <div className="mb-11 border-b pb-12 dark:border-gray-700 lg:pb-32">
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-300 md:max-w-lg">
                    ...
                    Illo vero rerum ea! Distinctio blanditiis sapiente
            ...
            <div className="w-full p-8 md:flex-1">
              <div className="mx-auto text-center md:max-w-2xl">
                <h2 className="font-heading tracking-px-n mb-10 text-center text-3xl font-bold leading-tight md:text-5xl">
                  You can even view events based on your college
                </h2>
                <div className="mb-12 md:inline-block">
                  <button
      ...
      {/* Footer Section */}
      <footer className="overflow-hidden pt-24">
        <div className="container mx-auto px-4">
          <div className="border-b pb-20">
            <div className="-m-8 flex flex-wrap">
              <div className="w-full p-8 sm:w-1/2 lg:w-2/12">
                <h3 className="mb-6 font-semibold leading-normal text-black dark:text-white">
                  Company
                </h3>
                <ul>
                  <li className="mb-3.5">
              ...
              <div className="w-full p-8 sm:w-1/2 lg:w-4/12">
                <div className="lg:max-w-sm">
                  ...
                  <p className="mb-5 font-sans leading-relaxed text-gray-600 dark:text-gray-400">
                  ...
                  <div className="mb-3 inline-block w-full overflow-hidden rounded-xl border border-gray-300 focus-within:ring focus-within:ring-indigo-300 md:max-w-xl xl:pl-6">
                    <div className="flex flex-wrap items-center">
                      <div className="w-full xl:flex-1">
                        <input
                          className="w-full bg-transparent p-3 font-medium text-gray-500 placeholder-gray-500 outline-none xl:p-0 xl:pr-6"
                          id="footerInput1-1"
                          type="text"
                      ...
                      <div className="w-full xl:w-auto">
                        <div className="block">
                          <button className="w-full border border-indigo-700 bg-indigo-600 py-4 px-8 font-semibold text-white transition duration-200 ease-in-out hover:bg-indigo-700 focus:ring focus:ring-indigo-300">
                            Subscribe
                          </button>
                        </div>
                      </div>
          ...
          <div className="-m-4 flex flex-wrap items-center justify-between py-6">
            ...
            <div className="w-auto p-4">
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">
                Copyright © 2023 DevUI. All Rights Reserved
              </p>
            </div>
            <div className="w-auto p-4">
